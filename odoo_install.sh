...
echo "what is the name of the user or odoo instance"
read OE_USER
OE_HOME="/opt/$OE_USER"
...
echo "is WKHTMLTOPDF installed on the pc (y or n)?"
read wkhtmltopdf
if [ $wkhtmltopdf = y ]; then
...
echo "What port do you want to use for odoo?:"
read OE_PORT
...
echo "What version do you want to install (7.0, 8.0 or 9.0)?"
read OE_VERSION

#set the superadmin password

echo "What do you want the admin password for odoo to be?"
read OE_SUPERADMIN
